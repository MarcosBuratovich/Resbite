...
class TwTypography {
  ...
  static TextStyle labelXs(BuildContext context) =>
...
ThemeData createTailwindTheme({bool isDark = false}) {
  final ColorScheme colorScheme = ColorScheme(
    ...
    surfaceContainerHighest: isDark ? TwColors.slate700 : TwColors.slate100,
