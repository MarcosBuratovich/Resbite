...
class ResbiteDetailsScreen extends ConsumerWidget {
  ...
  const ResbiteDetailsScreen({
    super.key,
    required this.resbiteId,
  });

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // Watch resbite data
    final resbiteAsync = ref.watch(resbiteProvider(resbiteId));
  ...
  Widget _buildResbiteDetails(BuildContext context, WidgetRef ref, Resbite resbite) {
                ...
                child: Row(
                  children: [
                    ...
                    Chip(
                      ...
                      backgroundColor: _getStatusColor(context, resbite.status).withOpacity(0.1),
                      side: BorderSide(
                        color: _getStatusColor(context, resbite.status).withOpacity(0.3),
                        width: 1,
                      ),
                    ...
                    Chip(
                      ...
                      labelStyle: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w500,
                        color: resbite.attendanceLimit != null && 
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            child: Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: resbite.activity!.imageUrl != null
                                      ? Image.network(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (resbite.activity!.categories.isNotEmpty) ...[
                                        const SizedBox(height: 4),
                                        Text(
                                          resbite.activity!.categories.first.name,
                        ...
                        child: Column(
                          children: [
                            ...
                            ListTile(
                              ...
                              subtitle: Text(
                                resbite.place?.name ?? resbite.meetingPoint ?? 'Location not specified',
                                style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                                  fontWeight: FontWeight.w500,
                                ),
                              ),
                              trailing: resbite.place != null 
                                ? Icon(
                                    Icons.map_outlined,
                                    color: Theme.of(context).colorScheme.primary,
                                  )
                                : null,
                              onTap: resbite.place != null 
                                ? () {
                            ...
                            // Meeting point
                            if (resbite.meetingPoint != null && resbite.meetingPoint!.isNotEmpty) ...[
                              const Divider(indent: 72, endIndent: 16),
                              ListTile(
                                leading: Container(
                                  width: 40,
                    ...
                    _buildActionButton(context, ref, resbite, isOwner, isParticipant),
                    const SizedBox(height: 40),
                  ],
                ),
              ),
    ...
    if (isPast) {
      ...
      return FilledButton.icon(
        ...
        style: FilledButton.styleFrom(
          ...
          disabledForegroundColor: Theme.of(context).colorScheme.onErrorContainer,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(16),
          ),
          textStyle: Theme.of(context).textTheme.labelLarge,
      ...
      return OutlinedButton.icon(
        onPressed: () async {
          ...
          try {
            ...
            final _ = ref.refresh(resbiteProvider(resbite.id));
      ...
      return FilledButton.icon(
        ...
        style: FilledButton.styleFrom(
          minimumSize: const Size(double.infinity, 56),
          disabledBackgroundColor: Theme.of(context).colorScheme.errorContainer.withOpacity(0.5),
          disabledForegroundColor: Theme.of(context).colorScheme.onErrorContainer,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(16),
          ),
          ...
          FilledButton(
            onPressed: () async {
              ...
              if (context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: const Text('Resbite cancellation feature coming soon'),
                    behavior: SnackBarBehavior.floating,
                    backgroundColor: Theme.of(context).colorScheme.secondary,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(8),
